...
choice = int(input("Que voulez-vous faire ? 1 = Tester les fonctionnalités de la classe, 2 = Générer un mot dans une langue choisie, 3 = Prédire la langue d'un mot"))
